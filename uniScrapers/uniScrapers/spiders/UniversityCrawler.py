...
class UniversityCrawler(Spider):
    ...
    start_urls=[
                 "http://tools.canlearn.ca/cslgs-scpse/cln-cln/rep-fit/p/af.p.clres.do?institution_id=default&searchType=ALL&searchString=&progLang=A&instType=B&prov_4=prov_4&progNameOnly=N&start=1&finish=20&section=1"
               ]
